      ...
      "/status/browser": {
        get: {
          ...
          parameters: [
            ...
            queryStringParam("dataset", "Built-in list selection: java or bedrock."),
            queryStringParam("list", "Alias for dataset."),
            queryStringParam("edition", "java, bedrock, or auto."),
            queryStringParam("page", "1-based page index used with dataset mode."),
            queryStringParam("perPage", "Page size used with dataset mode (max 100)."),
